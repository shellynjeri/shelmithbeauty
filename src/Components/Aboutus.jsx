    ...
    <ul className='corevaluesul'>
      ...
      <div className="row bg-danger p-4 mt-4">
        ...
        <div className="col-md-4">
          ...
          <Link to="https://www.facebook.com"><img src="images/fb.png" alt="facebook"></img></Link>
          <Link to="https://www.instagram.com"><img src="images/in.png" alt="instagram"></img></Link>
          <Link to="https://www.x.com"><img src="images/x.png" alt="twitter" width="50px"></img></Link>
